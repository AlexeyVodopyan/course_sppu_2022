# -*- coding: utf-8 -*-
"""
Created by 'kolya' on 11.05.2022 at 0:23
"""
...
class FirstTaskWell:
    """ class for first task of 2nd homework"""
    def __init__(
        self,
        fluid_data: dict,
    ...
    def calc_p_wf_min_fountain(
        ...
        """
        return Min BHP for flowing for defined WH
...
class SecondTaskWell(GasLiftWell):
    """ class for second task of 2nd homework """
    def __init__(
        self,
        *args,
        reservoir_data: dict,
...
def calc_temp(
    ...
    """ Pressure distribution calc """
    return t_res - (tvd_vdp - tvd_h) / 100 * t_grad


def First_Homework_Solution(
    fluid_data: dict,
    inclinometry_data: dict,
    temp_dist_data: dict,
    casing_data: dict,
...
def main(
    ...
    hw_1_solution = First_Homework_Solution(
        fluid_data=fluid_data,
        inclinometry_data=inclinometry_data,
        temp_dist_data=temp_dist_data,
        casing_data=casing_data,
    ...
    hw_2_solution = Second_Homework_Solution(
        fluid_data=fluid_data,
        inclinometry_data=inclinometry_data,
        temp_dist_data=temp_dist_data,
        casing_data=casing_data,
...
def get_homework_solution():
    ...
    file_1_name = "3-1.json"
    file_2_name = "3-2.json"
    ...
    (fluid_data,
     ...
     regime_data,
     equipment_data,
     ) = arrange_input_data(file_1=file_1_path, file_2=file_2_path)

    first_solution = First_Homework_Solution(
        fluid_data=fluid_data,
        inclinometry_data=inclinometry_data,
        temp_dist_data=temp_dist_data,
        casing_data=casing_data,
    ...
    second_solution = Second_Homework_Solution(
        fluid_data=fluid_data,
        inclinometry_data=inclinometry_data,
        temp_dist_data=temp_dist_data,
        casing_data=casing_data,
    ...
    final_results = {"t1": first_solution, "t2": second_solution}

    save_results(obj_to_save=final_results,save_path=save_path)
if __name__ == "__main__":
    get_homework_solution()